...
　　運営側
        ...
        <form method="POST" action="{{ route('admin.register') }}">
            ...
            <div>
                <x-label for="r_name" :value="__('代表者の名前')" />

                <x-input id="r_name" class="block mt-1 w-full" type="text" name="r_name" :value="old('r_name')" required autofocus />
            </div>

            <div>
                <x-label for="add2" :value="__('会社の住所')" />

                <x-input id="add2" class="block mt-1 w-full" type="text" name="add2" :value="old('add2')" required autofocus />
            </div>
