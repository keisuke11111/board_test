        ...
        <div class="flex justify-between items-stretch mb-5">
            <div class="flex flex-col w-6/12 mr-5">
                <div class="flex flex-col w-full">
                    ...
                    <input type="text" name="title" value="{{$teer->title}}" class="w-full h-10 px-3 text-lg border-2 border-gray-200 outline-none">
                </div>

                <div class="flex flex-col w-full">
                    <label class="text-gray-700 text-sm">　開催期間<em class="text-xs text-pink-600">必須</em></label>
                    <input type="text" name="period" value="{{$teer->period}}" class="w-full h-10 px-3 text-lg border-2 border-gray-200 outline-none">  
                </div>
                <div class="flex flex-col w-full">
                    <label class="text-gray-700 text-sm">　時間帯<em class="text-xs text-pink-600">必須</em></label>
                    <input type="text" name="time" value="{{$teer->time}}" class="w-full h-10 px-3 text-lg border-2 border-gray-200 outline-none">  
                </div>
                <div class="flex flex-col w-full">
                    <label class="text-gray-700 text-sm">　募集期間<em class="text-xs text-pink-600">必須</em></label>
                    <input type="text" name="b_boshu" value="{{$teer->b_boshu}}" class="w-full h-10 px-3 text-lg border-2 border-gray-200 outline-none">  
                </div>
                <div class="flex flex-col w-full">
                    <label class="text-gray-700 text-sm">　料金<em class="text-xs text-pink-600">必須</em></label>
                    <input type="text" name="money" value="{{$teer->money}}" class="w-full h-10 px-3 text-lg border-2 border-gray-200 outline-none">  
                </div>
                <div class="flex flex-col w-full">
                    <label class="text-gray-700 text-sm">　定員<em class="text-xs text-pink-600">必須</em></label>
                    <input type="text" name="capacity" value="{{$teer->capacity}}" class="w-full h-10 px-3 text-lg border-2 border-gray-200 outline-none">  
                </div>
                <div class="flex flex-col w-full">
                    <label class="text-gray-700 text-sm">　対象者<em class="text-xs text-pink-600">必須</em></label>
                    <input type="text" name="human" value="{{$teer->human}}" class="w-full h-10 px-3 text-lg border-2 border-gray-200 outline-none">  
                </div>
                <div class="flex flex-col w-full">
                    <label class="text-gray-700 text-sm">　場所<em class="text-xs text-pink-600">必須</em></label>
                    <input type="text" name="place" value="{{$teer->place}}" class="w-full h-10 px-3 text-lg border-2 border-gray-200 outline-none">  
                </div>
                <div class="flex flex-col w-full">
                    <label class="text-gray-700 text-sm">　住所<em class="text-xs text-pink-600">必須</em></label>
                    <input type="text" name="address" value="{{$teer->address}}" class="w-full h-10 px-3 text-lg border-2 border-gray-200 outline-none">  
                </div>
                <div class="flex flex-col w-full">
                    <label class="text-gray-700 text-sm">　最寄り駅<em class="text-xs text-pink-600">必須</em></label>
                    <input type="text" name="moyori" value="{{$teer->moyori}}" class="w-full h-10 px-3 text-lg border-2 border-gray-200 outline-none">  
                </div>
            ...
            <div class="flex flex- items-stretch flex-grow">
                ...
                <textarea name="coment" class="w-full h-full text-lg px-2 py-2 border-2 border-gray-200">{{$teer->coment}}</textarea>
            </div>
            写真
            <div class="flex flex-row items-stretch flex-grow">
                <input  type="file" name="img_path"onchange="previewFile(this);"accept="image/*" value="{{$teer->img_path}}"> 
                </div>
